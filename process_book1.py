...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('process_book1_log.txt', encoding='utf-8'),
...
def extract_fields(data: Dict) -> Tuple[str, str, Dict]:
    ...
    Returns:
        (question, answer, original_fields) 元组
    """
...
async def process_single_file(file_path: Path, semaphore: asyncio.Semaphore, session=None) -> Tuple[str, bool, str]:
    """
    处理单个文件
